              ...
              <Image
                ...
                alt={
                  !cardSelected
                    ...
                    : `image of ${selectedCard.name} a ${selectedCard.type} on the ${selectedCard.team}`
                }
                className="object-cover h-36 md:h-64 w-fit rounded-l-md z-10"
                fill
              />
              <p className="w-36 md:w-64 text-xs align-middle justify-center text-center items-center">
