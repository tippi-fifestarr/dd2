...
contract DiscountRankedAccess is ERC721Base {
   using PriceConverter for uint256;

   using Counters for Counters.Counter;
   Counters.Counter private _tokenIdCounter;
   // Minimum price of NFT $2 in MATIC (shifted the price to .02 for easy testing)
//    uint256 public constant MINIMUM_USD = .02 * 10 ** 18;
uint256 public constant MINIMUM_USD = 2 * 10 ** 16;
